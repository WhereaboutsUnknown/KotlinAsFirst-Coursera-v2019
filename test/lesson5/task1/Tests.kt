...
class Tests {
    ...
    fun bagPacking() {
        ...
        assertEquals(
            setOf("Меч", "Амулет", "Кольцо"),
            bagPacking(
                mapOf(
                    "Кубок" to (10 to 100), "Слиток" to (10 to 500), "Меч" to (100 to 1000),
                    "Кольцо" to (1 to 600), "Булыжник" to (40 to 1), "Амулет" to (10 to 5000)
                ),
                120
            )
        )
        assertEquals(
            setOf("Меч", "Амулет", "Кольцо", "Слиток"),
            bagPacking(
                mapOf(
                    "Кубок" to (10 to 100), "Слиток" to (10 to 500), "Меч" to (100 to 1000),
                    "Кольцо" to (1 to 600), "Булыжник" to (40 to 1), "Амулет" to (10 to 5000)
        ...
        assertEquals(
            setOf("Амулет", "Кольцо", "Слиток", "Кубок", "Булыжник"),
            bagPacking(
                mapOf(
                    "Кубок" to (10 to 100), "Слиток" to (10 to 500), "Меч" to (100 to 1000),
                    "Кольцо" to (1 to 600), "Булыжник" to (40 to 1), "Амулет" to (10 to 5000)
